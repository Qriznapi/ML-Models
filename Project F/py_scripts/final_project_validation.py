...
PROJECT_DIR = Path(r"D:\test\test")
DB_PATH = PROJECT_DIR / "ewc_2026_fantasy_compact.sqlite"
REQUIRED_FILES = [
    DB_PATH,
    PROJECT_DIR / "02_ewc2026_fact_agent_FINAL_clean.ipynb",
    PROJECT_DIR / "ewc_fact_agent_tools.py",
    PROJECT_DIR / "fantasy_profile_constructor.py",
    PROJECT_DIR / "fantasy_banner_optimizer.py",
    PROJECT_DIR / "ewc_fantasy_dashboard.py",
    PROJECT_DIR / "requirements_dashboard.txt",
    PROJECT_DIR / "regression_tests.py",
    PROJECT_DIR / "add_reliability_confidence_intervals.py",
    PROJECT_DIR / "cleanup_legacy_sqlite_objects.py",
    PROJECT_DIR / "polish_public_analytics_layer.py",
    PROJECT_DIR / "db_cleanup_legacy_objects_report.md",
    PROJECT_DIR / "db_public_analytics_layer_report.md",
    PROJECT_DIR / "EWC2026_DB_GUIDE.md",
]
